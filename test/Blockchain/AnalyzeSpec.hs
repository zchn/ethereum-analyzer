    ...
    do it "works for hexcode1" $
       ...
       it "works for hexcode2" $
         do let decompiled2 = show $ showOps $ decompileHexString hexcode2
            decompiled2 `shouldBe` "[\"(2,PUSH [96])\"," ++
              "\"(4,PUSH [64])\"," ++
              "\"(5,MSTORE)\"," ++
              "\"(6,CALLDATASIZE)\"," ++
              "\"(7,ISZERO)\"," ++
              ...
              "\"(18,CALLDATALOAD)\"," ++
              "\"(19,DIV)\"," ++
              "\"(24,PUSH [65,192,225,181])\"," ++
              "\"(25,DUP2)\"," ++
              "\"(26,EQ)\"," ++
              "\"(28,PUSH [110])\"," ++
              "\"(29,JUMPI)\"," ++
              "\"(30,DUP1)\"," ++
              "\"(35,PUSH [229,34,83,129])\"," ++
              "\"(36,EQ)\"," ++
              "\"(38,PUSH [150])\"," ++
              "\"(39,JUMPI)\"," ++
              "\"(40,JUMPDEST)\"," ++
              ...
              "\"(69,AND)\"," ++
              "\"(70,SWAP1)\"," ++
              "\"(103,PUSH [144,137,8,9,198,84,241,29,110,114,162,143,166,1,73,119,10,13,17,236,108,146,49,157,108,235,43,176,164,234,26,21])\"," ++
              "\"(104,SWAP1)\"," ++
              "\"(106,PUSH [32])\"," ++
              "\"(107,SWAP1)\"," ++
              "\"(108,LOG3)\"," ++
              ...
              "\"(211,POP)\"," ++
              "\"(212,POP)\"," ++
              "\"(213,JUMP)\"," ++ "\"(214,JUMPDEST)\"," ++ "\"(215,STOP)\"]"
